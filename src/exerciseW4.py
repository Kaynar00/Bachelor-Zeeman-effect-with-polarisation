...
plt.subplots_adjust(wspace = space + 0.1, hspace = space + 0.05)
...
params.add('B_',value=500,min=10,max=20000)
params.add('ddopller_',value=0.3,min=0,max=1)
params.add('v_LOS',value=20,min=-30,max=30)
params.add('aimag',value=0.1,min=0,max=1)
params.add('theta',value=m.radians(41),min=m.radians(0),max=m.radians(180))
params.add('Xi',value=m.radians(26),min=m.radians(0),max=m.radians(360))
...
with open("spectrafit2noise5.txt","w") as f:
    f.write(fit_report(result))
